...
const backendPipeline = new BackendPipelineStack(app, 'AiSocialMediaBackendPipeline', {
  ...
  fbPrepProcessor: backend.fbPrepProcessor,
  fbPrepGcsUploadProcessor: backend.fbPrepGcsUploadProcessor,
  fbPrepCollectBatchProcessor: backend.fbPrepCollectBatchProcessor,
  fbPrepSubmitBatchProcessor: backend.fbPrepSubmitBatchProcessor,
  webhookEcrRepo: registry.webhookEcrRepo,
